...
### Definições
- **Criptografia** refere-se à ciência e arte de **projetar cifras**.
...
- Em geral, uma definição de segurança possui dois componentes:
  ...
  - **Modelo de ameaça:** Descreve o poder do adversário, ou seja, quais ações ele é <u>capaz de realizar</u>.
...
- Provas são especialmente importantes porque existe um atacante tentando ativamente **quebrar o sistema**.
- Provas de segurança fornecem uma garantia sólida — **relativa às definições e suposições adotadas** — de que nenhum atacante terá sucesso.
