\section{Introdução}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{img/01-introducao/tv-a-cabo.png}
    \end{figure}

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{img/01-introducao/tv-a-cabo2.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{img/01-introducao/dsl.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.55\textwidth]{img/01-introducao/rede-domestica.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.35\textwidth]{img/01-introducao/rede-institucional.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.35\textwidth]{img/01-introducao/cabos-tp.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{img/01-introducao/cabo-coaxial.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{img/01-introducao/fibra-optica.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.55\textwidth]{img/01-introducao/retardo.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.45\textwidth]{img/01-introducao/fila-e-perda.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.25\textwidth]{img/01-introducao/encaminhamento-roteamento.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.3\textwidth]{img/01-introducao/comutacao-circuitos.png}
    \end{figure}
    ...
    \begin{itemize}[left=0.5cm, align=left, nosep]
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.35\textwidth]{img/01-introducao/multiplexicacao-por-frequencia.png}
        \end{figure}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.35\textwidth]{img/01-introducao/multiplexicacao-por-tempo.png}
        \end{figure}
    \end{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{img/01-introducao/infraestrutura1.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{img/01-introducao/infraestrutura2.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{img/01-introducao/infraestrutura3.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{img/01-introducao/infraestrutura4.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{img/01-introducao/infraestrutura5.png}
    \end{figure}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{img/01-introducao/hierarquia.png}
    \end{figure}

   \subsection{Performance}
    
        \textbf{Como ocorre a perda e o retardo de pacotes ?}

        \begin{center}
                \includegraphics[width=0.5\textwidth]{img/01-introducao/delay1.png}
            \end{center}
        ...
        \textbf{Retardo do Pacote: 4 Causas}
        \begin{itemize}[left=0.5cm, align=left, nosep]
            \item O retardo ocorre a cada nó (ou salto) na rede : 
        \end{itemize} 
        
        \begin{center}
            \includegraphics[width=0.45\textwidth]{img/01-introducao/delay2.png}
        \end{center}

        \textbf{Componentes do Retardo :}
            ...
            \begin{itemize}[left=0.5cm, align=left, nosep]
                ...
                \begin{itemize}[left=0.5cm, nosep, label=$\hookrightarrow$]
                    ...
                    \item Envolve tarefas como: Conferir a integridade do pacote e verificar o endereço de saída do pacote.
        ...
        \textbf{Exemplo: Caravanas de Carros}
            
            \begin{center}
                \includegraphics[width=0.65\textwidth]{img/01-introducao/carro-pedagio.png}
            \end{center}

            O pedágio leva 12 s para atender cada carro (tempo de transmissão). A estrada tem pedágios a cada 100 km. 
            Um carro se propaga a 100 km/h.

            Analogia :\textbf{1 Carro} $\rightarrow$ 1 \textbf{bit}, \textbf{Caravana} $\rightarrow$ \textbf{pacote}, 
            \textbf{Pedágio} $\rightarrow$ \textbf{roteador}, \textbf{Estrada} $\rightarrow$ \textbf{enlace}.
            
            \textbf{Pergunta 1:} Quanto tempo levaria para a caravana de 10 carros chegar ao 2º pedágio ? 
            \begin{itemize}[left=0.5cm, align=left, nosep]
            ...
            \textbf{Pergunta 2:} Se os carros se propagam a 1000 km/h e o pedágio leva 1 min por carro? 
            \begin{itemize}[left=0.5cm, align=left, nosep]
    ...
    \textbf{Revisão: Retardo de Enfileiramento}
        \begin{itemize}[left=0.5cm, align=left, nosep]
        ...
        \begin{center}
            \includegraphics[width=0.4\textwidth]{img/01-introducao/retardo-de-enfileiramento.png}
        \end{center}
        ...
        \begin{itemize}[left=0.5cm, align=left, nosep]
            ...
            \begin{center}
                \includegraphics[width=0.7\textwidth]{img/01-introducao/traceroute-exemplo.png}
            \end{center}
            ...
            \begin{center}
                \includegraphics[width=0.45\textwidth]{img/01-introducao/perda-de-pacotes.png}
            \end{center}
            ...
            \begin{center}
                \includegraphics[width=0.4\textwidth]{img/01-introducao/vazao.png}
            \end{center}

            \begin{center}
                \includegraphics[width=0.4\textwidth]{img/01-introducao/exemplo-vazao.png}
            \end{center}

            \begin{center}
                \includegraphics[width=0.4\textwidth]{img/01-introducao/exemplo-vazao2.png}
            \end{center}
    ...
    \subsection{Camadas de Protocolos e Modelos de Serviços}
        ...
        \textbf{Questão inicial:} Existia alguma maneira de organizar a estrutura da Internet? \\
        \textbf{Exemplo}: Organização para Viajar de Avião

        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\textwidth]{img/01-introducao/exemplo-aviao.png}
        \end{figure}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\textwidth]{img/01-introducao/exemplo-aviao2.png}
        \end{figure}

        \textbf{Por que usar camadas ?} 
            \begin{itemize}[left=0.5cm, align=left, nosep]
        ...
        \textbf{Pilha de Protocolos da Internet (TCP/IP)}
            \begin{itemize}[left=0.5cm, align=left, nosep]   
            ...
            \textbf{Exemplo de camadas de protocolos :} 
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.4\textwidth]{img/01-introducao/encapsulamento.png}
        \end{figure} 
