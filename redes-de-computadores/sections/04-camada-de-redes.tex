\section{Camada de Redes - Plano de Dados}
            ...
            \begin{itemize}[left=0.5cm, align=left, nosep]
                ...
                \begin{table}[h!]
                    ...
                    \begin{tabular}{|l|c|}
                        ...
                        11001000 00010111 00010*** ******** & 1 \\ \hline
                        11001000 00010111 00011000 ******** & 2 \\ \hline
                        11001000 00010111 00011*** ******** & 3 \\ \hline
                    \end{tabular}
    ...
    \subsection{MiddleBox}
        ...
        \begin{itemize}[left=0.5cm, align=left, nosep]
            \item Qualquer \textbf{caixa intermediária} que estiver realizando \underline{funções distintas} das funções que 
            normalmente/por padrão são realizadas por roteadores IP no caminho de dados entre o 
            hospedeiro de origem e o hospedeiro de destino.
            \item Equipamentos que ocorrem no núcleo da rede e que realizam ações para além das ações já previstas

            \begin{center}
                \includegraphics[width=0.6\textwidth]{img/cap-04/exemplos-middleboxes.png}
            \end{center}

            \item Inicialmente: Soluções de hardware \underline{proprietárias} (fechadas).
            \item Movimento em direção ao hardware \textbf{“whitebox”} implementando API aberta 
            \begin{itemize}[left=0.5cm, nosep, label=$\hookrightarrow$]
                \item Afastar-se das soluções de hardware proprietárias
                \item Ações \textbf{locais programáveis} via match+action (correspondência + ação)
                \item Movimento em direção à inovação/diferenciação no software
            \end{itemize}
            \item \textbf{SDN} (Software Defined Networking): Controle e gerenciamento de configuração (logicamente) centralizados, 
            frequentemente em nuvem pública/privada
            \item \textbf{Virtualização de funções de rede (NFV):} Serviços programáveis sobre whitebox de rede, 
            computação e armazenamento
         
        \end{itemize}

        \subsubsection*{Ampulheta IP}
            \begin{center}
                \includegraphics[width=0.6\textwidth]{img/cap-04/ampulheta01.png}
            \end{center}
            
            \begin{center}
                \includegraphics[width=0.6\textwidth]{img/cap-04/ampulheta02.png}
            \end{center}
        
        \subsubsection*{Princípios da Arquitetura da Internet}
            \begin{itemize}[left=0.5cm, align=left, nosep]
                \item Objetivo: \textbf{Conectividade}, a ferramente para fazer isso é 
                o \textbf{IP} e toda a inteligência é fim-a-fim ao invês de estar no núcleo da rede.
                \item Pilares Principais:
                \begin{itemize}[left=0.5cm, nosep, label=$\hookrightarrow$]
                    \item Conectividade simples e universal
                    \item Protocolo IP
                    \item Inteligência e complexidade nas bordas da rede 
                \end{itemize}    
            \end{itemize}
        
        \subsubsection*{O argumento fim-a-fim}
            \begin{itemize}[left=0.5cm, align=left, nosep]
                \item Algumas funcionalidades da internet podem ser implementadas na \textbf{rede}, ou na \textbf{borda da rede}.
                \item Complexidade é tratada nos sistemas finais   
                \begin{center}
                    \includegraphics[width=0.6\textwidth]{img/cap-04/exemplo-fim-a-fim.png}
                \end{center}  
            \end{itemize}
